    ...
    return (
        <div class="one-half column">
            ...
            <Form onSubmit={sendInformation}>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label class="label">Nombre dueño</Form.Label>
